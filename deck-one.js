...
for(let x = deckOne.length - 1; x > 0; x--) { //Start at deck.length - 1 (pos 53 - 1 = pos 52); continue iterating as long as x > pos 0; x-- to iterate increments of one down from pos 52
    ...
    let temp = deckOne[x]; //Create temporary value equal to pos x in deck
    deckOne[x] = deckOne[y]; // pos x ins deck now equals pos y in deck
    deckOne[y] = temp; // pos y in deck becomes new temp
